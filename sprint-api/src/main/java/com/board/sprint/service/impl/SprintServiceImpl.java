...
public class SprintServiceImpl implements SprintService {
    ...
    public SprintServiceImpl(SprintRepository repository, Mapper<Sprint, SprintDto> mapper, @Qualifier("com.board.sprint.client.ProjectClient") ProjectClient projectClient, @Qualifier("com.board.sprint.client.TeamClient") TeamClient teamClient) {
